...
const Registration = () => {
    ...
    const handleRegister = event =>{
        ...
        console.log(email, password, displayName,picture, terms);
        ...
        setSuccess(' ');
         ...
         .then(()=>{
          alert('email verificaton link has been sent');
          return;
         })
         .catch(error => {
      ...
      <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-sky-100  mx-auto my-8 ">
        ...
        <form  onSubmit={handleRegister} className="space-y-4">
          <div className="space-y-1 text-sm">
            <label name="nameLabel" className="block dark:text-gray-400">
              User Name
            </label>
            <input
              type="text"
          ...
          <div className="space-y-1 text-sm">
            ...
            <input
              ...
              name="picture"
              id="picture"
              className="w-full  py-2 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400"
            />
          </div>
          <div className="space-y-1 text-sm">
            <label name="emailLabel" className="block dark:text-gray-400">
              User Email
            </label>
            <input
              type="email"
          ...
          <div className="space-y-1 text-sm relative">
            <label name="passwordLabel" className="block dark:text-gray-400">
              Password
            </label>
            <input
          ...
          <button className="block w-full p-3 text-center rounded-sm bg-sky-500 text-white font-bold">
            Sign Up
          </button>
        </form>

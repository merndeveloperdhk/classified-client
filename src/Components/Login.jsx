...
const Login = () => {
    ...
    const{user,loading, setLoading, googleSingIn, logIn} = useContext(AuthContext);
    ...
    return (
      ...
      <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-sky-100  mx-auto my-8 ">
        ...
        <form onSubmit={handleSubmit}  className="space-y-6">
          ...
          <input  className="block w-full p-3 text-center rounded-sm bg-sky-500 text-white font-bold" type="submit" value='Sign In'  />
